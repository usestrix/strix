...
if TYPE_CHECKING:
    from aisec.telemetry.tracer import Tracer
...
from aisec.llm import LLM, LLMConfig, LLMRequestFailedError
from aisec.llm.utils import clean_content
from aisec.tools import process_tool_invocations
...
class BaseAgent(metaclass=AgentMeta):
    ...
    def _add_to_agents_graph(self) -> None:
        from aisec.tools.agents_graph import agents_graph_actions
    ...
    async def _wait_for_input(self) -> None:
        ...
        if self.state.has_waiting_timeout():
            ...
            try:
                from aisec.tools.agents_graph.agents_graph_actions import _agent_graph
    ...
    async def _initialize_sandbox_and_state(self, task: str) -> None:
        ...
        if not sandbox_mode and self.state.sandbox_id is None:
            from aisec.runtime import get_runtime
    ...
    def _check_agent_messages(self, state: AgentState) -> None:  # noqa: PLR0912
        try:
            from aisec.tools.agents_graph.agents_graph_actions import _agent_graph, _agent_messages
