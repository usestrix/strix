...
from aisec.tools.registry import register_tool
...
def create_agent(
    ...
    try:
        ...
        if module_list:
            from aisec.prompts import get_all_module_names, validate_module_names
        ...
        from aisec.agents import AisecAgent
        from aisec.agents.state import AgentState
