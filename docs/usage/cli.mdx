...
Interactive scans use the Go/Bubble Tea interface. It supports targetless
interactive setup for providers, credentials, models, and targets. If the Go
sidecar cannot activate, Strix exits with guidance; failures after Go TUI
activation are surfaced rather than switching interfaces mid-session.
