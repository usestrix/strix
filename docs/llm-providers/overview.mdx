...
| Kimi K2.5         | Moonshot AI   | `openai/kimi-k2.5`               |
...
For OpenAI-compatible hosted providers like Moonshot:
...
<CardGroup cols={2}>
  ...
  <Card title="Moonshot AI" href="/llm-providers/moonshot">
    Kimi K2.5 via Moonshot's OpenAI-compatible API.
  </Card>
