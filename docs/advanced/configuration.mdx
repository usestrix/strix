...
<ParamField path="STRIX_CAIDO_BOOT_WAIT_S" default="300" type="integer">
  Maximum time in seconds to wait for the in-sandbox Caido proxy to become ready.
  Increase this on slow or heavily loaded container hosts.
</ParamField>
