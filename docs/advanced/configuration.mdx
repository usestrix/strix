...
<ParamField path="STRIX_EVENTS_RETENTION_DAYS" default="30" type="integer">
  Retention window for local telemetry logs (`strix_runs/<run_name>/events.jsonl`). Files older than this are pruned at startup. Set to `0` to disable automatic pruning.
</ParamField>
...
export STRIX_EVENTS_RETENTION_DAYS="30"

# Optional: Remote OTEL export (dual-write local + remote)
export TRACELOOP_BASE_URL="https://otel.your-company.com"
export TRACELOOP_API_KEY="your-api-key"

# Optional: Langfuse style headers
export TRACELOOP_HEADERS='{"Authorization":"Basic <base64-public-secret>"}'
```
