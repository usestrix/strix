...
- Docker (running)
- An LLM API key from any [supported provider](/llm-providers/overview) (OpenAI, Moonshot, Anthropic, Google, etc.)
...
<Tip>
For best results, use `openai/gpt-5.4`, `openai/kimi-k2.5` with `LLM_API_BASE=https://api.moonshot.ai/v1`, `anthropic/claude-opus-4-6`, or `openai/gpt-5.2`.
</Tip>
