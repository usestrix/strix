...
Official platform wheels include the Go TUI. Source distributions and universal
wheels built from source omit that platform binary; running interactively from
those installs requires a Go toolchain (`go run`) or `STRIX_TUI_BINARY`.
