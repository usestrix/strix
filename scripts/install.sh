...
echo -e "     ${MUTED}https://docs.strix.ai/usage/models${NC}"
echo ""
echo -e "  ${CYAN}2.${NC} Set your environment:"
echo -e "     ${MUTED}export STRIX_API_KEY='your-api-key'${NC}"
echo -e "     ${MUTED}export STRIX_LLM='strix/claude-opus-4.5'${NC}"
echo ""
...
echo -e "${MUTED}Supported models ${NC}https://docs.strix.ai/usage/models"
