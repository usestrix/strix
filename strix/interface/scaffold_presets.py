...
SCAFFOLD_PRESETS: dict[str, str] = {
    ...
    "infra-cloud": (
        ...
        "with the aws, azure, gcp, kubernetes, subdomain_takeover, cicd_pipeline_"
        "security, and dependency_cve_scanning skills before anything else. Still "
        "record coverage and file any other class of finding you encounter along the "
        "way — this is a priority ordering, not an exclusion list."
    ),
    "client-side": (
        ...
        "loaded with the xss, csrf, clickjacking, prototype_pollution, and "
